...
export const api = {
  ...
  snippets: {
    ...
    get:    (id: string) => http.get(\/snippets/\\).then((r) => r.data),
    create: (data: CreateSnippetInput) => http.post('/snippets', data).then((r) => r.data),
    update: (id: string, data: UpdateSnippetInput) =>
      http.patch(\/snippets/\\, data).then((r) => r.data),
    remove: (id: string) => http.delete(\/snippets/\\).then((r) => r.data),
    invite: (id: string, email: string, role: 'Editor' | 'Viewer') =>
      http.post(\/snippets/\/collaborators\, { email, role }).then((r) => r.data),
    removeCollab: (id: string, userId: string) =>
      http.delete(\/snippets/\/collaborators/\\).then((r) => r.data),
  },
  ...
  folders: {
    ...
    remove: (id: string) => http.delete(\/folders/\\).then((r) => r.data),
  },
}
